...
typedef struct ___structs_List_closure214_ctx __structs_List_closure214_ctx;
...
struct ___structs_List_closure214_ctxClass;
typedef struct ___structs_List_closure214_ctxClass __structs_List_closure214_ctxClass;
...
void structs_List__List_get(structs_List__List* this, uint8_t* __genericReturn62, lang_Numbers__SSizeT index);
...
void structs_List__List_removeAt(structs_List__List* this, uint8_t* __genericReturn63, lang_Numbers__SSizeT index);
lang_types__Bool structs_List__List_remove(structs_List__List* this, uint8_t* element);
void structs_List__List_set(structs_List__List* this, uint8_t* __genericReturn64, lang_Numbers__SSizeT index, uint8_t* element);
...
void structs_List__List_first(structs_List__List* this, uint8_t* __genericReturn65);
void structs_List__List_first_impl(structs_List__List* this, uint8_t* __genericReturn65);
void structs_List__List_last(structs_List__List* this, uint8_t* __genericReturn66);
void structs_List__List_last_impl(structs_List__List* this, uint8_t* __genericReturn66);
...
__structs_List_closure214_ctxClass *__structs_List_closure214_ctx_class();
void __structs_List_closure214_ctx___load__();
void structs_List_load();
lang_types__Bool structs_List____structs_List_closure208(lang_types__Closure f, lang_types__Bool* result, uint8_t* elem);
lang_types__Bool structs_List____structs_List_closure208_thunk(uint8_t* elem, __structs_List_closure208_ctx* __context__);
void structs_List____structs_List_closure211(lang_types__Closure f, structs_List__List* copy, lang_types__Class* K, uint8_t* x);
void structs_List____structs_List_closure211_thunk(uint8_t* x, __structs_List_closure211_ctx* __context__);
void structs_List____structs_List_closure214(lang_types__Closure f, structs_List__List* copy, uint8_t* x);
void structs_List____structs_List_closure214_thunk(uint8_t* x, __structs_List_closure214_ctx* __context__);
void structs_List____OP_IDX_List_SSizeT__T(uint8_t* __genericReturn61, lang_types__Class* T, structs_List__List* list, lang_Numbers__SSizeT i);
