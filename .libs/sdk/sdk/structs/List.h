...
struct ___structs_List_closure214_ctx {
    lang_types__Closure f;
    structs_List__List* copy;
};
...
#ifdef OOC_FROM_C
#define __structs_List_closure208(f, result, elem) structs_List____structs_List_closure208((f), (result), (elem))
#define __structs_List_closure208_thunk(elem, __context__) structs_List____structs_List_closure208_thunk((elem), (__context__))
#define __structs_List_closure211(f, copy, K, x) structs_List____structs_List_closure211((f), (void*) (copy), (void*) (K), (x))
#define __structs_List_closure211_thunk(x, __context__) structs_List____structs_List_closure211_thunk((x), (__context__))
#define __structs_List_closure214(f, copy, x) structs_List____structs_List_closure214((f), (void*) (copy), (x))
#define __structs_List_closure214_thunk(x, __context__) structs_List____structs_List_closure214_thunk((x), (__context__))
...
#define List_get(_this_, __genericReturn62, index) structs_List__List_get((void*) (_this_), (__genericReturn62), (index))
...
#define List_removeAt(_this_, __genericReturn63, index) structs_List__List_removeAt((void*) (_this_), (__genericReturn63), (index))
#define List_remove(_this_, element) structs_List__List_remove((void*) (_this_), (element))
#define List_set(_this_, __genericReturn64, index, element) structs_List__List_set((void*) (_this_), (__genericReturn64), (index), (element))
...
#define List_first(_this_, __genericReturn65) structs_List__List_first((void*) (_this_), (__genericReturn65))
#define List_last(_this_, __genericReturn66) structs_List__List_last((void*) (_this_), (__genericReturn66))
