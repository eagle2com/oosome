...
struct ___lang_Format_closure223_ctx {
...
#ifdef OOC_FROM_C
#define argNext(__genericReturn17, T, va, T) lang_Format__argNext((__genericReturn17), (T), (va), (void*) (T))
...
#define format_main(__genericReturn21, fmt, ...) lang_Format__format_main((__genericReturn21), (fmt), __VA_ARGS__)
#define __lang_Format_closure223(end, start, p) lang_Format____lang_Format_closure223((void*) (end), (start), (p))
#define __lang_Format_closure223_thunk(__context__) lang_Format____lang_Format_closure223_thunk((__context__))
