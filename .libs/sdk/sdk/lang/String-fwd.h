...
typedef struct ___lang_String_closure226_ctx __lang_String_closure226_ctx;
struct _lang_String__StringClass;
typedef struct _lang_String__StringClass lang_String__StringClass;
struct ___lang_String_closure226_ctxClass;
typedef struct ___lang_String_closure226_ctxClass __lang_String_closure226_ctxClass;
...
__lang_String_closure226_ctxClass *__lang_String_closure226_ctx_class();
void __lang_String_closure226_ctx___load__();
...
void lang_String____lang_String_closure226(lang_Character__Char** argv, structs_ArrayList__ArrayList* result, lang_Numbers__LLong i);
void lang_String____lang_String_closure226_thunk(lang_Numbers__LLong i, __lang_String_closure226_ctx* __context__);
...
lang_String__String* lang_String____OP_ADD_LDouble_String__String(lang_Numbers__LDouble left, lang_String__String* right);
lang_String__String* lang_String____OP_ADD_String_LDouble__String(lang_String__String* left, lang_Numbers__LDouble right);
