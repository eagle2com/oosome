...
typedef struct ___lang_Format_closure223_ctx __lang_Format_closure223_ctx;
...
struct ___lang_Format_closure223_ctxClass;
typedef struct ___lang_Format_closure223_ctxClass __lang_Format_closure223_ctxClass;
...
__lang_Format_closure223_ctxClass *__lang_Format_closure223_ctx_class();
void __lang_Format_closure223_ctx___load__();
extern lang_Numbers__Int lang_Format__TF_ALTERNATE;
extern lang_Numbers__Int lang_Format__TF_ZEROPAD;
extern lang_Numbers__Int lang_Format__TF_LEFT;
extern lang_Numbers__Int lang_Format__TF_SPACE;
extern lang_Numbers__Int lang_Format__TF_EXP_SIGN;
extern lang_Numbers__Int lang_Format__TF_SMALL;
extern lang_Numbers__Int lang_Format__TF_PLUS;
extern lang_Numbers__Int lang_Format__TF_UNSIGNED;
...
void lang_Format__argNext(uint8_t* __genericReturn17, lang_VarArgs__VarArgsIterator* va, lang_types__Class* T);
...
void lang_Format__format_main(uint8_t* __genericReturn21, lang_types__Class* T, uint8_t* fmt, lang_VarArgs__VarArgs args);
void lang_Format____lang_Format_closure223(lang_types__Pointer end, lang_Character__Char* start, lang_Character__Char** p);
void lang_Format____lang_Format_closure223_thunk(__lang_Format_closure223_ctx* __context__);
